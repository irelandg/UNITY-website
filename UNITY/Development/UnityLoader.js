...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'UNITY.data';
    var REMOTE_PACKAGE_BASE = 'UNITY.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 2531200;
      var PACKAGE_UUID = 'e0870d6c-19f9-4ab2-9514-bf5e65e65401';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 157668, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(157668, 157687, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(157687, 157839, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(157839, 1628603, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1628603, 2503575, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2503575, 2531200, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_UNITY.data');

    };
    Module['addRunDependency']('datafile_UNITY.data');
